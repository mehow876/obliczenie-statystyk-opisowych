...
def click_fun(win, label):
    global sciezka_pliku_label, combobox_kolumny
    global srednia_val, mediana_val, odch_std_val, rozstep_val
    label.config(text="[ Temat 10: Statystyka ]")
    # Uruchomienie okna statystyki
...
if __name__ == '__main__':
    ...
    konsol = ttk.Label()  # Tworzymy tymczasową etykietę (wymagana jako argument)
    click_fun(root, konsol)
